...
public class StoreRestController {
    ...
    public ApiResponse<ReviewResponseDTO.ReviewPreViewListDTO> getReviewList(@Valid @PathVariable(name = "storeId") Long storeId, @RequestParam(name = "page") Integer page){
